...
<!-- sección de inicio de sesión comienza  -->
...
<section class="form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data" class="login">
      ...
      <p class="link">¿no tienes una cuenta? <a href="register.php">regístrate ahora</a></p>
      <input type="submit" name="submit" value="iniciar sesión ahora" class="btn">
   </form>
