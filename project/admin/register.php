...
if(isset($_POST['submit'])){
   ...
   if($select_tutor->rowCount() > 0){
      ...
      if($pass != $cpass){
         ...
         $message[] = 'Nuevo psicologo registrado! por favor inicie sesión ahora';
      }
   }
...
<section class="form-container">
   ...
   <form class="register" action="" method="post" enctype="multipart/form-data">
      ...
      <p class="link">¿ya tienes una cuenta? <a href="login.php">inicia sesión ahora</a></p>
