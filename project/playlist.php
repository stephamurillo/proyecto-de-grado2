...
<section class="playlist">
   ...
   <div class="row">
      ...
      <div class="options"><button id="btnShow"class="btn" onclick="ShowHide()" style="width: 90px; height:40px;"> Chat</button>
</div>
   ...
   <div class="container2" style="height: 100px; width: 100px; ;">
<iframe src="./ChatApp - CodingNepal/index.php" width="500%"
height="700%" text-align: center;></iframe>
</div>
   </div>
</section>
...
<section class="videos-container">
   ...
   <div class="box-container" style="margin-left: 20vh;">
